    ...
    <>
      <header
        ...
        <div className="menu-wrap">
          <div
            className={`main-menu style-2 ${state.isSidebarOpen ? "show-menu" : ""}`}
            
          >
            <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center" style={{
              background: '#0a141d',
              padding: ' 20px'
            }}>
              <div className="mobile-logo-wrap">
                <Link legacyBehavior href="/">
                  <a>
                    <img alt="image" src="assets/img/white-logo.png" />
                  </a>
                </Link>
              </div>
            </div>
