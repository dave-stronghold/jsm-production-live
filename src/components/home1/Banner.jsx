          ...
          <div className="row">
            <div className="col-lg-12 gap-lg-4 gap-4 d-flex flex-md-nowrap flex-wrap align-items-center justify-content-between">
              <div className="banner-content">
                <span>Jehova Sabaoth Ministries</span>
                <h1>
                  Raising and Equipping the Last Days Army for God's Glory !
                </h1>
              </div>
          ...
          <div className="row g-lg-4 gy-5">
            ...
            <div className="col-lg-5 order-lg-2 order-1">
              <div className="banner-right-content pl--95">
                <h5>
                The Word of God says, "You can do all things through Christ who strengthens you" - Philippians 4:13
                </h5>
