...
const HorizontalScroll = () => {
  return (
    ...
    <div className="single-scroll-container three" style={{backgroundImage: 'linear-gradient(180deg, rgba(0, 0, 0, 0.25) 0%, rgba(0, 0, 0, 0.25) 100%), url(assets/img/home1/event-img.jpg)'}}>
        ...
        <div className="horizontal-scrolling-content">
          <div className="content-left">
            <div className="section-title1 two">
              ...
              <h2>Special Family Blessing Gathering</h2>
              <ul>
                <li>
                ...
                <li>
                  <Link legacyBehavior href="/event-details">
                    <a>
                    <svg xmlns="http://www.w3.org/2000/svg" width={13} height={13} viewBox="0 0 13 13">
                      <mask id="mask0_380_595" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x={0} y={0} width={13} height={13}>
                        <rect width={13} height={13} />
                      </mask>
                      <g mask="url(#mask0_380_595)">
          ...
          <div className="content-right-wrap">
            <div className="content-right">
              ...
              <div className="content">
                <p>Join us in faith, for blessings abound, as we gather in unity, pursuing Christ's light, enriching our family with divine grace.</p>
              </div>
            </div>
          </div>
        </div>
