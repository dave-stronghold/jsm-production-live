      ...
      <div className="col-lg-12">
        ...
        <div className="row g-4">
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="people-card2 two magnetic-item">
              <div className="people-img">
                <img src="assets/img/inner-pages/people-img9.png" alt="" />
                <ul className="social-icon">
                  <li><a href="https://www.linkedin.com/"><i className="bx bxl-linkedin" /></a></li>
                  <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a></li>
                </ul>
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="people-card2 two magnetic-item">
              <div className="people-img">
                <img src="assets/img/inner-pages/people-img10.png" alt="" />
                <ul className="social-icon">
                  <li><a href="https://www.linkedin.com/"><i className="bx bxl-linkedin" /></a></li>
                  <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a></li>
                </ul>
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="people-card2 two magnetic-item">
              <div className="people-img">
                <img src="assets/img/inner-pages/people-img11.png" alt="" />
                <ul className="social-icon">
                  <li><a href="https://www.linkedin.com/"><i className="bx bxl-linkedin" /></a></li>
                  <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a></li>
                </ul>
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="people-card2 two magnetic-item">
              <div className="people-img">
                <img src="assets/img/inner-pages/people-img12.png" alt="" />
                <ul className="social-icon">
                  <li><a href="https://www.linkedin.com/"><i className="bx bxl-linkedin" /></a></li>
                  <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a></li>
                </ul>
