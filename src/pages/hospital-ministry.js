            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6 blog-details-page">
                <blockquote>
                  ...
                  <cite>James 5:14-15</cite>
                </blockquote>
              </div>
              <div className="col-lg-5">
                <div className="details-page-content">
                  <h2>Hospital Ministry</h2>

                  <p className="first-para pb-20">
                    Throughout the New Testament, we see examples of early
                    Christians following Jesus' example by caring for the sick
                    and ministering to those in hospitals and homes. In James
                    5:14-15, believers are encouraged to pray for the sick and
                    anoint them with oil, demonstrating faith in God's healing
                    power and His desire for wholeness and restoration.
                  </p>
                  <p>
                    Hospital ministry is a reflection of Christ's love and
                    compassion for the suffering, offering comfort,
                    encouragement, and prayer to patients and their families
                    during times of illness and distress. It provides an
                    opportunity to be the hands and feet of Jesus, bringing hope
                    and healing to those who are hurting and in need of God's
                    touch.
                  </p>
                </div>
              </div>
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-8">
                <div className="statement-content">
                  ...
                  <p>
                    {" "}
                    In our Hospital Ministry Journey, we delve into various
                    aspects of faith and healing, exploring how God's love and
                    teachings can bring comfort and restoration even in the
                    midst of illness and suffering. Let's embark on this
                    compassionate journey together as we explore the following
                    topics:
                  </p>
              ...
              <div className="col-lg-4">
                <div className="advantage-img two">
                  <img src="assets/img/inner-pages/hospital-img.jpg" alt="" />
                </div>
              </div>
            </div>
          </div>
