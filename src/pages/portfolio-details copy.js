      ...
      <div className="row g-lg-4 gy-5">
        <div className="col-lg-8">
          <div className="statement-content">
            ...
            <p>In an era characterized by rapid technological advancements and shifting consumer preferences, traditional banks are confronted with the imperative to undergo a comprehensive digital banking transformation. The traditional banking model, reliant on physical branches and manual processes, faces a multitude of challenges that hinder competitiveness, customer satisfaction, and operational efficiency.</p>
...
{/* <div className="people-section two mb-130"> 
  <div className="container-fluid one pl--95">
    <div className="row g-lg-4 gy-5">
      <div className="col-lg-5">
        <div className="people-left-content pr--95">
          <div className="section-title1 mb-0 two">
      ...
      <div className="col-lg-7">
        <div className="row g-4">
          <div className="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
            <div className="people-card2 two white-bg magnetic-item">
...
<div className="case-study-navigation-section mb-130">
  <div className="container-fluid one pl--95">
    <div className="row">
