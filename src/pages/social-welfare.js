              ...
              <div className="col-lg-6 blog-details-page">
                <blockquote>
                  ...
                  <p>
                    ...
                    of the afflicted, then your light shall rise in the darkness
                    and your gloom be like the noonday.
                  </p>
                  <cite>Isaiah 58:10</cite>
                </blockquote>
              </div>
              <div className="col-lg-5">
                <div className="details-page-content">
                  ...
                  <p className="first-para pb-20">
                    Social welfare ministry, rooted in biblical principles,
                    embodies compassion, justice, and love for one's neighbor.
                    It reflects God's concern for the marginalized and
                    vulnerable, seen throughout Scripture in commands to care
                    for the poor, the widow, and the orphan.
                  </p>
                  <p>
                    Through practical acts of kindness and advocacy for justice,
                    social welfare ministry demonstrates God's love in action,
                    fulfilling the teachings of Jesus to feed the hungry, clothe
                    the naked, and care for the sick and imprisoned. It serves
                    as a tangible expression of faith, embodying the call to
                    love and serve others as an integral part of Christian
                    discipleship.
                  </p>
                </div>
              </div>
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-8">
                <div className="statement-content">
                  ...
                  <p>
                    {" "}
                    In our Social Welfare Ministry Journey, we explore various facets of compassion and community empowerment, discovering how God's love and teachings can bring hope and change to those in need. Join us as we embark on this transformative journey together, exploring topics such as:
                  </p>
              ...
              <div className="col-lg-4">
                <div className="advantage-img two">
                  <img src="assets/img/inner-pages/social-img.jpg" alt="" />
                </div>
              </div>
            </div>
          </div>
